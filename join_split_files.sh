...
cat product/app/WallpaperPicker_apo/WallpaperPicker_apo.apk.* 2>/dev/null >> product/app/WallpaperPicker_apo/WallpaperPicker_apo.apk
rm -f product/app/WallpaperPicker_apo/WallpaperPicker_apo.apk.* 2>/dev/null
...
cat vendor_bootimg/03_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null >> vendor_bootimg/03_dtbdump_	qcom,rtic-id.dtb
rm -f vendor_bootimg/03_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null
