...
DEVICE_PATH := device/hmd/APO_sprout
...
TARGET_KERNEL_CONFIG := APO_sprout_defconfig
TARGET_KERNEL_SOURCE := kernel/hmd/APO_sprout
...
include vendor/hmd/APO_sprout/BoardConfigVendor.mk
